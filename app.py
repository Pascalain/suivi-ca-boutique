...
annee_n = st.sidebar.selectbox("Année en cours (N)", [2024, 2025, 2026], index=2)
annee_n1 = st.sidebar.selectbox("Comparer avec (N-1)", [2024, 2025, 2026], index=1)
...
if not df.empty:
    ...
    if not df_filtre.empty:
        ...
        recap = recap[[annee_n1, annee_n, 'Écart', 'Evol %']]
